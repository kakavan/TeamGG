...
public OnPlayerSpawn(id){
	...
	// Выдаём оружие из списка согласно уровню игрока
	rg_give_item(id, PrimaryWeapons[g_iPlayerLevel[id]], GT_REPLACE);
	new weaponId = get_weaponid(PrimaryWeapons[g_iPlayerLevel[id]]);
	rg_set_user_bpammo(id, weaponId, rg_get_weapon_info(weaponId, WI_MAX_ROUNDS)); //Выдаём боеприпасы
